...
import (
	...
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/chat"// BOT名字
	//                          ^^^^^^^^^^^^^^                          //
	//                      ^^^^^^^高优先级区^^^^^^^                      //
	//               ^^^^^^^^^^^^^^高优先级区^^^^^^^^^^^^^^               //
	// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^高优先级区^^^^^^^^^^^^^^^^^^^^^^^^^^^^ //
	...
	//                      vvvvvvv中优先级区vvvvvvv                      //
	//                          vvvvvvvvvvvvvv                          //
	_"设置ai绘图配置 http://91.216.169.75:5010 abc"
...
func init() {
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "纳西妲"),
